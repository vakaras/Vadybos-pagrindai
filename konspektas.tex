...
\begin{enumerate}
  ...
  \item „iš apačios į viršų“ – žemiausio lygio vadovai formuoja
    ...
    valdymo lygiuose;
  \item mišrus variantas;
  \item variantas pritraukiant išorės konsultantus.
\end{enumerate}
...
\begin{itemize}
  ...
  \item operatyviai priimami sprendimai;
  \item aiški motyvacija (pinigai).
\end{itemize}
...
\begin{itemize}
  ...
  \item visas dėmesys tik einamiesiems reikalams, neskiriama dėmesio
    strategijai;
  \item didėjant veiklos apimtis ženkliai didėja užimtumas darbais.
\end{itemize}
...
Privalumai:
\begin{itemize}
  \item didelis lankstumas ir dėmesys vartotojui;
  \item aiški atsakomybė;
...
\begin{itemize}
  ...
  \item atsiranda galimybė susiformuoti komandai: kitoks tarpusavio 
    supratimas, bendrų tikslų prioritetas;
...
\begin{itemize}
  ...
  \item lankstumas;
  \item mažesnis valdymo personalo poreikis;
...
\begin{description}
  ...
  \item[Išlygintos piramidės] struktūra: eliminuojama vidurinioji
    valdymo grandis; pagerėja komunikacijos kanalai tarp sprendimus
    priimančių ir juos vykdančių.
  \item[Šerdies ir žiedo (branduolio ir periferijos)] struktūra:
    šerdį sudaro vadovai, įgyvendinantys strategiją; tokia organizacija
    yra dinamiška, joje nėra griežtai apibrėžtų hierarchinių lygmenų,
    nes darbas vyksta projektų realizavimo principu.
\end{description}
